...
ifeq ($(config),debug_x64)
  ...
  Engine_config = debug_x86
  raylib_config = debug_x86

else ifeq ($(config),debug_arm64)
  Engine_config = debug_arm64
...
ifneq (,$(Engine_config))
	...
	@${MAKE} --no-print-directory -C build/build_files -f Engine.make config=$(Engine_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Engine.make clean
